...
def truncate_for_csv(data, max_length: int = 131000, suffix: str = "...[TRUNCATED]") -> str:
    ...
    * `max_length` and `suffix` are kept for compatibility with existing callers
    * Returns the full string because csv.field_size_limit applies to reads, not writes
    '''
    try:
