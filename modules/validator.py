...
def validate_secrets() -> None | ValueError | TypeError:
    ...
    # URL is required for OpenAI-compatible and DeepSeek clients, not Gemini,
    # and not when AI is disabled (users may leave llm_api_url empty).
    if use_AI and ai_provider != "gemini":
